      ...
      social: [
        {
          icon: "github",
          label: "GitHub",
          href: "https://github.com/anonchatx",
        },
      ],

      editLink: {
        baseUrl:
          "https://github.com/anonchatx/anonchatx.github.io/edit/main/src/content/docs/",
      },
          ...
          items: [
...

            {
              ...
              items: [
                ...
                { label: "AnonChatX Mailbox", link: "/docs/usage/settings/mailbox" },
