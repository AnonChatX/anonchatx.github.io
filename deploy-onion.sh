#!/usr/bin/env bash
#
# AnonChatX — Onion Website Deployment Script
#
# This script deploys the AnonChatX website to a self-hosted server
...
# - nginx configured to serve /var/www/anonchatx
# - Tor onion service pointing to the nginx instance
#
# This script is part of the AnonChatX project and is provided
...
WEB_ROOT="${WEB_ROOT:-/var/www/anonchatx}"
